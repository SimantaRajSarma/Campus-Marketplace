...
error_reporting(0);
    ...
    $sql = "SELECT items.*, item_images.image_url, categories.category_name, users.username AS buyer_username, users.address AS buyer_address
    FROM items
    INNER JOIN item_images ON items.item_id = item_images.item_id
    LEFT JOIN categories ON items.category_id = categories.category_id
    INNER JOIN transactions ON items.item_id = transactions.item_id
