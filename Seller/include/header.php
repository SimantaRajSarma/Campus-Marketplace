...
<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
            ...
            <i class="bi bi-person-fill"></i><span>Student</span><i class="bi bi-chevron-down ms-auto"></i>
            </a>
            <ul id="components-nav7" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                
                  <li class="nav-item">
            <a class="nav-link collapsed" href="AddStudents">
            <i class="bi bi-circle"></i>
              <span>Add Student</span>
                  ...
                  <li class="nav-item">
            <a class="nav-link collapsed" href="ManageStudent">
            <i class="bi bi-circle"></i>
           ...
           <i class="bi bi-person-workspace"></i><span>Webiner</span><i class="bi bi-chevron-down ms-auto"></i>
            </a>
            <ul id="components-nav8" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                
                  <li class="nav-item">
            <a class="nav-link collapsed" href="AddWebiner">
            <i class="bi bi-circle"></i>
              <span>Add Webiner</span>
            </a>
          </li><!-- End Register Page Nav -->
          
                
                  <li class="nav-item">
            <a class="nav-link collapsed" href="ManageWebiner">
            <i class="bi bi-circle"></i>
              <span>Manage Webiner</span>
            </a>
          </li><!-- End Register Page Nav -->
               
                
                  <li class="nav-item">
            <a class="nav-link collapsed" href="WebinerRegs">
            <i class="bi bi-circle"></i>
              <span>Webiner Registrations</span>
            </a>
          </li><!-- End Register Page Nav -->
       ...
       <i class="bi bi-camera-video-fill"></i><span>Live Class</span><i class="bi bi-chevron-down ms-auto"></i>
            </a>
            <ul id="components-nav9" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                
                  <li class="nav-item">
            <a class="nav-link collapsed" href="LiveClass">
            <i class="bi bi-circle"></i>
              <span>Add Live Class</span>
                  ...
                  <li class="nav-item">
            <a class="nav-link collapsed" href="ManageClass">
            <i class="bi bi-circle"></i>
              <span>Manage Live Class</span>
                ...
                <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#components-nav91" data-bs-toggle="collapse" href="#">
            <i class="bi bi-journal-album"></i><span>Mock Test</span><i class="bi bi-chevron-down ms-auto"></i>
            </a>
            <ul id="components-nav91" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                
                  <li class="nav-item">
            <a class="nav-link collapsed" href="AddMockTest">
            <i class="bi bi-circle"></i>
              <span>Add Mock Test</span>
                  ...
                  <li class="nav-item">
            <a class="nav-link collapsed" href="Manage_Mock">
            <i class="bi bi-circle"></i>
              <span>Manage Mock Test</span>
            </a>
          </li><!-- End Register Page Nav -->
            ...
            <i class="bi bi-book-half"></i><span>Study Material</span><i class="bi bi-chevron-down ms-auto"></i>
            </a>
            ...
            <i class="bi bi-circle"></i>
              <span>Add Study Material</span>
                  ...
                  <li class="nav-item">
            <a class="nav-link collapsed" href="Notes">
            <i class="bi bi-circle"></i>
              <span>Manage Study Material</span>
                ...
                <li class="nav-item">
            <a class="nav-link collapsed" href="Manage_Fees">
